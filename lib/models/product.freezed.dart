...
class _$_Product with DiagnosticableTreeMixin implements _Product {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Product(id: $id, title: $title, sub_title: $sub_title, price: $price, catgory_id: $catgory_id, image: $image)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('sub_title', sub_title))
      ..add(DiagnosticsProperty('price', price))
      ..add(DiagnosticsProperty('catgory_id', catgory_id))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.catgory_id, catgory_id) ||
                other.catgory_id == catgory_id) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, sub_title, price, catgory_id, image);
